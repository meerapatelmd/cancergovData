...
#' @format A data frame with 8156 rows and 3 variables:
#' \describe{
...
#' @title DRUG_LINK
#' @description DATASET_DESCRIPTION
#' @format A data frame with 10115 rows and 3 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 26224 rows and 4 variables:
#' \describe{
...
#' @title DRUG_LINK_URL
#' @description DATASET_DESCRIPTION
#' @format A data frame with 15837 rows and 3 variables:
#' \describe{
...
#' @description DATASET_DESCRIPTION
#' @format A data frame with 7792 rows and 3 variables:
#' \describe{
...
#' @title NCIT_SYNONYM
#' @description DATASET_DESCRIPTION
#' @format A data frame with 50018 rows and 7 variables:
#' \describe{
